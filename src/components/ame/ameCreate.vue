<template>
  <!-- this page is for getting all the input to add new amenity data -->
  <!-- Note: We have 3 more ..Create.vue to get input and push it each collection 
i.e Events,Attraction and Restaurants
=> One can use comments on this page as reference to other ..Create.vue code-->
  <div>
    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 10px;">
        <div class="container-fluid">
          ...
          <strong><a class="navbar-brand" style="color: darkblue;">TASIPA</a></strong>
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <router-link to="/3">
                  <a class="nav-link active" aria-current="page">Amenity</a>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/5">
    ...
    <!-- This part of code is for creating form to get input -->
    <div class="card card-body mt-4">
      <p style="color:#6666ff;">* All fields are mandatory</p>
      <form @submit.prevent="onSubmit">
        <div class="form-group">
          <label> Amenity Name</label>
          <input v-model="form.Name" class="form-control" placeholder="e.g. Tasipa Amenity" required />
        </div>
        <div class="form-group mt-3">
          <label>Description</label>
          <input v-model="form.Description" class="form-control" placeholder="e.g. This place is full of lovely people" required />
        </div>
        <div class="form-group mt-3">
          <label>Category</label>
          <input v-model="form.Category" class="form-control" placeholder="e.g. Fuel, Dental Clinic, Massage, Hair Salon" required />
        </div>
        <div class="form-group mt-3">
...
<script>
  ...
  export default {
    ...
    // this function gets all data from form and push it to firebaseAme.js
    setup() {
      const form = reactive({
        Name: '',
        Description: '',
